...
const InventoryCRUDTable = (props) => {
  ...
  const handleCreateNewRow = (values) => {
    let queryStr = 'http://https://pern-project-3.onrender.com/createOrUpdateInventoryItem';
  ...
  const getAllInventory = async() => {
    axios.get(`http://https://pern-project-3.onrender.com/readInventoryItems`, config)
    .then(res => {
