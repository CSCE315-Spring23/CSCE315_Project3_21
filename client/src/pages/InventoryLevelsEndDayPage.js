...
function placeRestockOnclick(){
    axios.get(`http://pern-project-3.onrender.com/inventoryLevelsEndDayCompletePlaceRestock`, config)
        .then(res => {
...
function endDayOnclick(){
    axios.get(`http://pern-project-3.onrender.com/inventoryLevelsEndDay`, config)
        .then(res => {
...
function InventoryLevelsEndDayPage() {
    ...
    function recordArrivalOnclick(){
        ...
        let str = `http://pern-project-3.onrender.com/inventoryLevelsEndDayArrive?id=`+idVal;
